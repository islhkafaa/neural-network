...
public:
  ...
  void conv2d(const DeviceBuffer &in, size_t in_offset, const Shape &in_shape,
              ...
              const Strides &bias_strides, DeviceBuffer &out, size_t out_offset,
              const Shape &out_shape, const Strides &out_strides,
              size_t padding, size_t stride) override;
  ...
  void conv2d_backward(
      ...
      const Strides &grad_bias_strides, size_t padding, size_t stride) override;

  void maxpool2d(const DeviceBuffer &in, size_t in_offset,
                 const Shape &in_shape, const Strides &in_strides,
                 DeviceBuffer &out, size_t out_offset, const Shape &out_shape,
                 const Strides &out_strides, size_t pool_h, size_t pool_w,
                 size_t stride) override;

  void maxpool2d_backward(const DeviceBuffer &in, size_t in_offset,
                          const Shape &in_shape, const Strides &in_strides,
                          const DeviceBuffer &out, size_t out_offset,
                          const Shape &out_shape, const Strides &out_strides,
                          const DeviceBuffer &grad_out, size_t grad_out_offset,
                          const Shape &grad_out_shape,
                          ...
                          const Strides &grad_in_strides, size_t pool_h,
                          size_t pool_w, size_t stride) override;
  ...
  void embedding_backward(const DeviceBuffer &grad_out, size_t grad_out_offset,
                          const Shape &grad_out_shape,
                          const Strides &grad_out_strides,
                          const DeviceBuffer &indices, size_t indices_offset,
                          const Shape &indices_shape,
                          const Strides &indices_strides,
